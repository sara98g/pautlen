%{
  ...
  int clase_actua, tipo_actual, tamano_actual=1;
...
programa: inicia_TS TOK_MAIN '{' declaraciones escribir_TS funciones inicia_main sentencias '}' {fprintf(salida,";R:\tprograma: TOK_MAIN '{' declaraciones funciones sentencias '}'\n");}
        | TOK_MAIN '{' funciones sentencias '}' {fprintf(salida,";R:\tprograma: TOK_MAIN '{' funciones sentencias '}'\n");}

        ;
inicia_TS: {  /*escribir_subseccion_data*/
  /*escribir_cabecera_bss despues de declaraciones*/};

inicia_main: {/*escribir_inicio_main*/};
...
escribir_TS: {/*saca de tabla de simbolos -> declarar_variable*/}
